...
export function rewrite_playlist(text: string, proxy_base_url: string, original_url: string, headers_json?: string | null): string;
...
export interface InitOutput {
    ...
    readonly parse_nz_channels: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly process_icon_url: (a: number, b: number) => [number, number];
    readonly rewrite_playlist: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => [number, number];
