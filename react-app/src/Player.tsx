    ...
    <header className="pointer-events-none fixed top-0 right-0 left-0 z-20 flex h-20 items-center justify-between bg-linear-to-b from-black/50 to-transparent px-4 sm:px-6 lg:px-8">
      ...
      <div className="pointer-events-auto flex items-center gap-3">
        <button
          ...
          className={`flex items-center gap-2 rounded-full border px-4 py-2 font-bold shadow-lg backdrop-blur-sm transition-all hover:scale-105 focus:ring-2 focus:ring-(--md-sys-color-primary) focus:ring-offset-2 focus:ring-offset-(--md-sys-color-background) focus:outline-none ${focusLocation === "header" && headerFocusAnchor === "stremio"
